...
public interface fileMapper {
    ...
    @Insert("insert into file(filePath,fileName,type,userId,userName,courseId,courseName,uploadTime)" +
            "values(#{filePath},#{fileName},#{type},#{userId},#{userName},#{courseId},#{courseName},#{uploadTime})")
